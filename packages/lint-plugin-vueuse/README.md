...
| [`@nustack/vueuse/prefer-use-clipboard`](https://github.com/Zerya-Dev/nustack/blob/master/packages/lint-plugin-vueuse/src/rules/prefer-use-clipboard/index.md) | Prefer `useClipboard()` over `navigator.clipboard`. |
| [`@nustack/vueuse/prefer-use-event-listener`](https://github.com/Zerya-Dev/nustack/blob/master/packages/lint-plugin-vueuse/src/rules/prefer-use-event-listener/index.md) | Prefer `useEventListener()` over `add/removeEventListener`. |
...
| [`@nustack/vueuse/prefer-use-window-size`](https://github.com/Zerya-Dev/nustack/blob/master/packages/lint-plugin-vueuse/src/rules/prefer-use-window-size/index.md) | Prefer `useWindowSize()` over direct `window.innerWidth`/`innerHeight`. |
